...
class TicketPriorityDropdown extends StatefulWidget {
  final String value;
  ...
  @override
  State<TicketPriorityDropdown> createState() => _TicketPriorityDropdownState();
}

class _TicketPriorityDropdownState extends State<TicketPriorityDropdown> {
  late final ValueNotifier<String?> _selectedValue;

  static const _items = ['low', 'normal', 'high', 'urgent'];
  ...
  @override
  void didUpdateWidget(TicketPriorityDropdown oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: AppDropdown<String>(
        title: context.translate('priority'),
        items: _items,
